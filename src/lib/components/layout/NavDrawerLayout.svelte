...
>
  ...
  <div
    class={`flex flex-col w-full p-3 xl:p-4 relative xl:sticky xl:top-0 xl:left-0 z-10 ${page.url.pathname !== '/' ? 'bg-surface-light-01 dark:bg-surface-dark-02 shadow-md dark:shadow-neutral-800' : ''}`}
  >
    <div class="flex flex-row items-center w-full gap-3">
      ...
      >
        <span
          aria-labelledby="nav_menu_toggle"
          class="iconify lucide--menu size-7 lg:size-6"
        ></span>
      </button>
      <Logo class="h-12" />
      <h1
        class="flex lg:hidden text-2xl font-bold text-ahhs-blue-700 dark:text-white"
      >
        AHHS
      </h1>
  ...
  <div class="drawer">
    ...
    <main id="main">
      ...
      <footer
        class="flex flex-col py-4 px-5 bg-ahhs-blue-400/5 dark:bg-ahhs-blue-200/10 mt-12"
      >
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
          ...
          <div class="flex flex-col w-full gap-3 items-center">
            ...
            <div class="grid grid-cols-1 gap-1 text-center">
              <a class="underline" href="mailto:info@almosthomehumane.org"
                >info@almosthomehumane.org</a
              >
        ...
        <div
          class="flex flex-col lg:flex-row w-full justify-center items-center py-4 gap-6 lg:gap-24"
        >
          ...
          <div class="flex flex-col items-center justify-center">
            ...
            <div class="flex flex-row gap-2 items-center justify-center">
              <a
                aria-label="Facebook"
                href="https://www.facebook.com/AlmostHomeHS/"
                target="_blank"
              >
              ...
              <a
                aria-label="Facebook"
                href="https://instagram.com/almosthomehumane"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 256 256"
                  class="size-8 lg:size-6 -mt-[5px]"
                  ><g fill="none"
                    ><rect
                      width="256"
                      height="256"
