...
<svelte:head>
  ...
  <meta name="description" content="Your donations allow us to do the work we do every day and help us fulfill our dreams for what we are able to do for pets in our community." />
</svelte:head>
  ...
  <PageTitle title='Frequently Asked Questions' />
    ...
    <section class="flex flex-col gap-3 basis-full">
      ...
      <div class="flex flex-col basis-full gap-1 px-4">
        ...
        <p class="px-4 lg:px-8">
          Almost Home has no time limit for pets in our care. Incoming pets must go through a decompression time, following a medical evaluation. Once up to date medically, and barring behavioral difficulties, pets are then available for adoption! The average length of stay for pets in 2023 was 40 days. Pets stay at Almost Home until they find the right forever home and in 2023 Almost Home's life-saving rate was 95%.          
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
        ...
        <p class="px-4 lg:px-8">
          AHHS is completely private with no government funding or contracts. We rely solely on grants, adoption fees, services, and donations from the public to keep our doors open for animals in need. Almost Home is a private non-profit organization and is not affiliated with any national organization.          
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
        ...
        <p class="px-4 lg:px-8">
          Almost Home’s lifesaving rate for {priorYear} was 95% which is above the 90% standard to qualify as a no-kill organization. AHHS is an unlimited stay humane society that accepts surrenders and transfers of pets in need. Thanks to the generous donors who support our injured animal program, Almost Home is able to treat many illnesses and injuries. Our AHHS animal care staff go to great lengths to work with our behaviorally challenged animals. Unfortunately, some animals must be euthanized either for severe medical or behavioral reasons. Euthanasia is not taken lightly at AHHS as we strive to provide the best outcome for every animal we meet.          
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
        ...
        <p class="px-4 lg:px-8">
          Almost Home serves more than 3,000 dogs, cats, rabbits, birds, guinea pigs and other pets each year through our variety of programs.          
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
      ...
      <div class="flex flex-col basis-full gap-1 px-4">
        ...
        <p class="px-4 lg:px-8">
          Some pets arrive to AHHS as stray transfers with little to no history; others are surrenders.  Age is estimated based upon the amount of tartar on teeth as well as the physical condition of the pet. Breed is an estimation based upon the size, body shape, and coloration. AHHS and our medical team take all traits into account to make our best estimate on age and breed, though we cannot guarantee either.          
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
        ...
        <p class="px-4 lg:px-8">
          Almost Home Humane Society is classified as a limited-admission shelter. We intake any pets in need, space and resources allowing. Those interested in surrendering must complete the Surrender Application found under "Resources". AHHS Staff with determine our available space and resources and contact you to schedule the surrender appointment!          
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
      ...
      <div class="flex flex-col basis-full gap-1 px-4">
        ...
        <p class="px-4 lg:px-8">
          Almost Home is not authorized to investigate cases of animal cruelty.  If you are concerned about a pet please contact your local animal control (Lafayette:  <a class="link" href="tel:+17658071200" target="_blank">(765) 807-1200</a>, West Lafayette: <a class="link" href="tel:+17657755200">(765) 775-5200</a>, Tippecanoe County:  <a class="link" href="tel:+17654239321">(765) 423-9321</a>).
        </p>
      </div>
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
        ...
        <p class="px-4 lg:px-8">
          Adopting a pet is a personal decision and a lifetime commitment for the adopter.  Almost Home feels it is very important to make a good match between adopter and pet and this often must be done in person. For this reason, AHHS does not allow pets to be adopted as gifts without the intended owner present.          
        </p>
      </div>       
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
      ...
      <div class="flex flex-col basis-full gap-1 px-4">
        ...
        <p class="px-4 lg:px-8">
          Almost Home working cats are feral cats that are not able to be returned to a local community cat colony, but could provide mousing services for farms, barns, etc. Our working cats are typically not social with people. These cats are available to homes willing to provide shelter (barn, warehouse, outbuilding), food, and water. All AHHS working cats are available free of charge and are already spayed or neutered, ear tipped, and vaccinated.          
        </p>
      </div>  
      <div class="flex flex-col basis-full gap-1 px-4">
        <h4 class="flex flex-row items-center text-xl font-medium gap-2">
        ...
        <p class="px-4 lg:px-8">
          Unfortunately, we are unable to provide euthanasia services to the public. We recommend contacting your primary veterinarian or emergency vet services.           
        </p>
      </div>                                                                   
      {/if}
    </section>    
