...
<div class="flex flex-col basis-full gap-6">
	<PageTitle title="Donate" tag="Help us help them" />
	<PageWrapper>
		<p>
			Each year more than 3,000 pets and their families seek the services of Almost Home. Your
			...
			every day and help us fulfill our dreams for what we are able to do for pets in our community.
		</p>
		<section class="flex flex-col basis-full gap-3">
			<h3 class="text-2xl font-medium">Donate Online</h3>
			<p>
				Click our donation link to make an online donation to AHHS. Want to ensure that your gift
				helps us all year long? Designate your gift as a monthly gift. Monthly gifts help us plan
				for our monthly needs and give much needed support for our programs and services.
			</p>
		...
		<section class="flex flex-col basis-full gap-3">
			...
			<p>
				You can always call us at <a class="link" target="_blank" href="tel:+17654745222"
					>(765) 474-5222</a
				> to make a credit card donation over the phone or to learn more about other ways to give.
			</p>
		</section>
		<section class="flex flex-col basis-full gap-3">
			<h3 class="text-2xl font-medium">Give Pet Food & Supplies</h3>
			<p>We are always in need of pet supplies and food.</p>
			<ul class="list-none">
				<li>
					<a
						class="link"
						href="https://www.amazon.com/hz/wishlist/ls/3OQ4XAMTVTHSF?ref_=wl_share"
						target="_blank"
					>
						Amazon Wishlist
					</a>
				...
				<li>
					<a
						class="link"
						href="https://prf.hn/click/camref:1011lffAB/destination:https%3A%2F%2Fwww.chewy.com%2Fg%2Falmost-home-humane-society_b71915690#wish-list"
						target="_blank"
					>
						Chewy Wishlist
					</a>
		...
		<section class="flex flex-col basis-full gap-3">
			...
			<p>
				Not ready to add a pet to your family right now? Help another family by sponsoring the
		...
		<section class="flex flex-col basis-full gap-3">
			...
			<p>
				You may be able to take advantage of significant tax advantages by exploring planned giving
				options, including gifts of stocks and bonds, estate gifts, and charitable annuities. We
				always recommend discussing your estate planning with your lawyer or tax advisor.
			</p>
		</section>
		<section class="flex flex-col basis-full gap-3">
			<h3 class="text-2xl font-medium">Legacy Giving</h3>
			<p>
				Help paw it forward for our community’s pets by making a legacy gift to Almost Home. You’ve
				...
				indefinitely to help the Almost Home care for the pets that need us the most.
			</p>
			<div class="flex flex-col basis-full gap-3 px-4">
				...
				<p>
					A beneficiary designation is the simplest way to make a legacy gift to Almost Home Humane
				...
				<p>Here are some common designation options:</p>
				<p>
					Retirement plans[e.g., traditional IRA, Keogh, 401(k)]: Including Almost Home as a
					...
					designation form and not through your will, which may jeopardize tax benefits.
				</p>
				<p>
					Savings accounts: Designating AHHS as a beneficiary of a savings account is simple and
					allows full use of savings during your life.
				</p>
				<p>
					The following is suggested language for unrestricted bequests to be used for the greatest
					current need of the Humane Society:
				</p>
				<p>
					I give to Almost Home Humane Society, Inc., a not-for-profit corporation organized under
				...
				<p>
					One way to “gift” life insurance is to designate your charity of choice as the
				...
				<p>
					You can also transfer ownership, assigning your charity of choice as BOTH owner and
					...
					deductible.Similar benefits also apply to annuities.
				</p>
				<h4 class="text-xl font-medium text-ahhs-red">Gifts of Securities are also Accepted</h4>
				<p>
					If you sell appreciated securities, you could lose up to 25% of your appreciation to
					...
					Development Department at (765) 474-5222.
				</p>
				<ul class="list-none">
		...
		<section class="flex flex-col basis-full gap-3">
			...
			<p>
				Almost Home is a private non-profit organization and not affiliated with any national or
				...
				donated helps us provide care to a pet in need.
			</p>
		</section>
		<section class="flex flex-col basis-full gap-3">
			<h3 class="text-2xl font-medium">Your Privacy</h3>
			<p>
				Almost Home will never sell, rent, or share our supporters’ names. To show our appreciation
				...
				name to be listed, please contact our Donation Department at <a
					class="link"
					target="_blank"
					href="tel:+17654745222">(765) 474-5222</a
				>.
			</p>
		</section>
	</PageWrapper>
