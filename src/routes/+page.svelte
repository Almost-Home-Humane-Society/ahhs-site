<script>
	import AdoptCard from "$lib/components/AdoptCard.svelte";
...
<div class="flex flex-col gap-6 w-full items-center">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 p-4 w-full lg:w-10/12">
    <div class="flex flex-col gap-3 items-center justify-around py-6">
        <span class="text-2xl lg:text-4xl xl:text-5xl font-bold text-ahhs-red-500 dark:text-ahhs-red-200 text-center text-pretty">Adopt a friend. Save a life.</span>
        <p class="text-base lg:text-xl 2xl:text-2xl lg:px-12 text-center">
          Almost Home Humane Society is a non-profit animal rescue shelter serving more than 3,000 annually in the greater Lafayette, Indiana area. AHHS accepts owner surrendered pets and pets transferred from other animal welfare organizations as shelter capacity allows and only by scheduled appointment.
        </p>
    </div>
    <div class="flex flex-row justify-center w-full h-[50vh] relative p-4">                 
      <img 
