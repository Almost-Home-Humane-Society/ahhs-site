import { p as push, f as attr_class, g as clsx, e as pop, h as attr, j as ensure_array_like, k as spread_props, l as fallback, m as slot, n as bind_props, o as head } from "../../chunks/index2.js";
...
function NavItem($$payload, $$props) {
  ...
  $$payload.out.push(`<li${attr_class(`nav-item py-0 px-0 ${props.disabled ? "disabled cursor-not-allowed" : "cursor-pointer"} ${isActive ? "active" : ""}`)}><a class="py-2 px-3 text-sm rounded-md"${attr("href", props.path)}${attr("target", props.external ? "blank" : void 0)}${attr("rel", props.external ? "noreferrer" : void 0)}>${escape_html(props.label)}</a></li>`);
  pop();
}
function NavSection($$payload, $$props) {
  push();
  let { $$slots, $$events, ...props } = $$props;
  let classList = (() => {
  ...
  $$payload.out.push(`<li${attr_class(`nav-section ${"my-0.5"}`)}>`);
  {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div${attr_class(clsx(classList))}><button class="nav-section-title cursor-pointer justify-start">${escape_html(props.title)} <span class="iconify lucide--chevron-up size-4"></span></button> `);
    {
      $$payload.out.push("<!--[-->");
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        if (Object.hasOwn(item, "label")) {
          $$payload.out.push("<!--[-->");
          NavItem($$payload, spread_props([item]));
        } else {
          $$payload.out.push("<!--[!-->");
          NavSection($$payload, spread_props([item]));
        }
        $$payload.out.push(`<!--]-->`);
      }
      $$payload.out.push(`<!--]-->`);
...
function Devtools($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="tsqd-parent-container"></div>`);
  bind_props($$props, {
    initialIsOpen,
    buttonPosition,
    position,
...
function _layout($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>AHHS</title>`;
    $$payload2.out.push(`<link rel="apple-touch-icon" sizes="180x180" href="favicon.png"/> <link rel="icon" type="image/png" sizes="32x32" href="favicon.png"/> <link rel="icon" type="image/png" sizes="16x16" href="favicon.png"/> <link rel="shortcut icon" href="favicon.ico"/> <link rel="manifest" href="manifest.json"/> <meta name="theme-color"${attr("content", themeColor)}/> <meta name="description" content="Almost Home Humane Society is a non-profit animal rescue shelter serving the greater Lafayette, Indiana area."/>`);
  });
  $$payload.out.push(`<div class="skip-to-main-link"><a href="#main">Skip to main content</a></div> `);
  QueryClientProvider($$payload, {
    client: queryClient,
    children: ($$payload2) => {
      {
        $$payload2.out.push("<!--[!-->");
        NavDrawerLayout($$payload2, {
          children: ($$payload3) => {
            children($$payload3);
            $$payload3.out.push(`<!---->`);
          }
      ...
      $$payload2.out.push(`<!--]--> `);
      Devtools($$payload2, { initialIsOpen: false });
      $$payload2.out.push(`<!---->`);
    },
    $$slots: { default: true }
  });
