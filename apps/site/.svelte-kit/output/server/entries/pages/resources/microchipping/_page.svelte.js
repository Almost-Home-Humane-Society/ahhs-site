...
function _page($$payload) {
  ...
  PageTitle($$payload, {
    title: "Microchipping",
    tag: "Peace of mind in the event of a lost pet."
  });
  $$payload.out.push(`<!----> `);
  PageWrapper($$payload, {
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Almost Home believes a microchip is the best form of identification for your pet because it is
			...
			through Friday 12:00-6:00 and Saturday 12:00-4:00. No appointment necessary!</p>`);
    }
  });
