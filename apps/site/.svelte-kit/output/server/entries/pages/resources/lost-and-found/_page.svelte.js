...
function _page($$renderer) {
  head($$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Lost &amp; Found Pets | AHHS</title>`);
    });
    $$renderer2.push(`<meta name="description" content="Report a lost or found pet."/>`);
  });
  $$renderer.push(`<div class="flex flex-col basis-full gap-6">`);
  PageTitle($$renderer, { title: "Lost or Found Pets", tag: "How to get a pet home." });
  $$renderer.push(`<!----> `);
  PageWrapper($$renderer, {
    children: ($$renderer2) => {
      $$renderer2.push(`<p>If you have found a pet, Almost Home strongly recommends sending a photo of the pet to Lost
