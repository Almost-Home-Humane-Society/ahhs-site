...
import { k as head } from "../../../chunks/index.js";
import { P as PageTitle } from "../../../chunks/PageTitle.js";
import { P as PageWrapper } from "../../../chunks/PageWrapper.js";
function _page($$renderer) {
  head($$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Donate | AHHS</title>`);
    });
    $$renderer2.push(`<meta name="description" content="Your donations allow us to do the work we do every day and help us fulfill our dreams for what we are able to do for pets in our community."/>`);
  });
  $$renderer.push(`<div class="flex flex-col basis-full gap-6">`);
  PageTitle($$renderer, { title: "Donate", tag: "Help us help them" });
  $$renderer.push(`<!----> `);
  PageWrapper($$renderer, {
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Each year more than 3,000 pets and their families seek the services of Almost Home. Your
