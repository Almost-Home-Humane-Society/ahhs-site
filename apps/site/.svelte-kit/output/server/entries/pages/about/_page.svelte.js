  ...
  $$renderer.component(($$renderer2) => {
    ...
    head($$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>About Us | AHHS</title>`);
      });
    ...
    PageTitle($$renderer2, { title: "About Us", tag: "How we serve our community" });
    $$renderer2.push(`<!----> `);
    PageWrapper($$renderer2, {
      children: ($$renderer3) => {
        $$renderer3.push(`<p>Almost Home Humane Society was formed as the Tippecanoe County Humane Association in 1939 and
        ...
        for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
          ...
          $$renderer3.push(`<tr><td align="center">${escape_html(row.name)}</td><td align="center">${escape_html(row.dog)}</td><td align="center">${escape_html(row.cat)}</td><td align="center">${escape_html(row.other)}</td></tr>`);
        }
        $$renderer3.push(`<!--]--></tbody></table> <div class="flex flex-col gap-3 justify-center"><p class="text-sm">*Stray pets are brought to Almost Home and held for 5 full days awaiting reunion with
