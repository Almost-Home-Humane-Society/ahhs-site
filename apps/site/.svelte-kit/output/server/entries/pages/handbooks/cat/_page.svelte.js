...
function Behavior($$payload) {
  Section($$payload, {
    title: "Reducing your cat's fearful behavior",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Flight, flee or freeze. No, it isn’t the latest game show sweeping the nation. Instead, these
		...
		from you in the form of training, patience, and love.</p> `);
      SubSection($$payload2, {
        title: "What causes fearful behavior?",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>You’ll need to observe your cat closely to determine the trigger for their fearful behavior.
			...
			behavior could be anything. Some common triggers are:</p> <ul class="list-disc pl-6"><li>A particular person</li> <li>A stranger</li> <li>Another animal</li> <li>A child</li> <li>Loud noises</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Take the following steps to reduce your cat’s anxiety and help him or her become more
			...
			to expect daily feeding, playing, cuddling and grooming.</p> <p>Try to desensitize your cat to fear stimulus by following these steps:</p> <ul class="list-disc pl-6"><li>Determine what distance your cat can be from the fear stimulus without responding fearfully</li> <li>Introduce the fear stimulus at this distance while you’re feeding your cat tasty treats and
				...
				paying careful attention to your cat so that you don’t progress too rapidly for him or her.</li> <li>You may need help with the desensitization process from an animal-behavior specialist.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "A not about agression",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your cat seriously threatens you, another person, or an animal- and the behavior is not an
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Do not punish your cat for his or her fearful behavior. Animals associate punishment with
				...
				their aggression toward you.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!---->`);
    }
...
function Introduction($$payload) {
  Section($$payload, {
    title: "Introducing your new cat to your other pets",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Some cats are more social than other cats. For example, an 8-year old cat who has never been
      ...
      SubSection($$payload2, {
        title: "Confinement",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Confine your new cat to one medium-sized room with her litter box, water and a bed. Feed your
			...
			the door until your pet can eat calmly while standing directly on either side of the door.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Swap the sleeping blankets or beds used by all the cats so they each have a chance to become
			...
			other, and repeat the whole process over a period of days - supervised, of course.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>It’s better to introduce your pets to each other gradually so that neither animal becomes
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Try to keep your resident pets schedules close to what they were before the newcomer’s
			...
			down before reintroducing them to each other.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>You’ll need to be even more careful when introducing a dog and a cat to one another. A dog can
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If introductions don’t go smoothly, seek professional advice immediately from a veterinarian
...
function Kitten($$payload) {
  Section($$payload, {
    title: "Understanding your kittens behavior and development",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>The apple doesn’t fall far from the tree, especially for cats. The fact is, well-socialized cats
		...
		of life.</p> `);
      SubSection($$payload2, {
        title: "0-2 weeks: neonatal period",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Kitten learns to orient toward sound.</li> <li>Eyes begin opening; they are usually open by 2 weeks of age.</li> <li>Competition for rank and territory begins. Separation from mother and litter mates at this
				point can lead to poor learning skills and aggression towards people and other pets.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "2-7 weeks: socialization period",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>By the third week, sense of smell is well developed and kittens can see well though to find
				...
				skills, and social interaction abilities.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "7-14 weeks: most active play period",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Social and object play increases kitten’s physical coordination and social skills. Most
				learning is by observation, preferably of kitten’s mother.</li> <li>Social play includes belly-ups, hugging, ambushing, and licking.</li> <li>Object play includes scooping, tossing, pawing, mouthing, and holding.</li> <li>Combined social/object play includes tail chasing, pouncing, leaping and dancing.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "3-6 months: ranking period",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Kittens are most influenced by their “litter,” which may now include playmates of other
      ...
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "6-18 months: adolescence",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Kitten increases exploration of dominance, including challenging humans.</li> <li>If not spayed or neutered, kitten experiences beginning of sexual behavior. (Spaying or
				neutering you kitten at an early age will increase the health benefits of the surgery and
				increase their lifespan).</li></ul>`);
        }
      });
      $$payload2.out.push(`<!---->`);
    }
...
function LitterBoxIntro($$payload) {
  Section($$payload, {
    title: "Introducing your cat to the litter box",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Most of us know cats are finicky eaters, but they can also be pretty picky when it comes to the
		other end of the digestive process - making use of a litter box. Fortunately, the following
		suggestions should keep your cat from “thinking outside the box.”</p> `);
      SubSection($$payload2, {
        title: "Location, location, location",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Most people are inclined to place the litter box in an out-of-the-way spot to minimize odor
			...
			the closet door and adding a pet door.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Research has shown that most cats prefer fine-grained litters, presumably because they have a
...
function LitterBoxProblems($$payload) {
  Section($$payload, {
    title: "Solving litter box problems",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>If you’re having hard time persuading your cat to head for the litter box when it’s appropriate,
		...
		that she’ll started using the litter box again.</p> `);
      SubSection($$payload2, {
        title: "Medical problems",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>It’s common for cats with medical problems to begin eliminating outside of their litter boxes.
			...
			for a thorough physical examination can rule out a medical problem.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Cleaning soiled areas",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Because animals are highly motivated to continue soiling an area that smells like urine or
			feces - and because cat’s sense of smell is so much stronger than humans’ - it’s important to
			thoroughly and properly clean the soiled areas.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Aversion to the litter box",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Your cat may have decided that the litter box is an unpleasant place to eliminate if:</p> <ul class="list-disc pl-6"><li>The box is nor clean enough for him/her.</li> <li>She has experience painful urination or defecation in the box due to a medical problem.</li> <li>She has been startled by a noise while using the box.</li> <li>She has been ambushed while in the box either by another cat, a child, a dog, or by you, if
      ...
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Surface preferences",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>All animals develop preferences for a particular surface on which they like to eliminate.
			...
			reasons that we don’t always understand. Your cat may have a surface preference if:</p> <ul class="list-disc pl-6"><li>He or she consistently eliminates on a particular texture for example, soft-textured
				...
				runner or aluminum foil or place citrus-scented cotton balls over the area.</p></div>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Your cat may have a location preference if:</p> <ul class="list-disc pl-6"><li>He or she always eliminates in quiet, protected places, such as under a desk, beneath a
				...
				it to a more convenient location at the rate of an inch per day.</p></div>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If you catch your cat in the act of eliminating outside the litter box, do something to
			...
			and trying to punish them will often make matters worse.</p>`);
        }
      });
      $$payload2.out.push(`<!---->`);
    }
...
function Reinforcement($$payload) {
  Section($$payload, {
    title: "Positive Reinforcement",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>We all like to be praised rather than punished. The same is true for your cat, and that’s the
		...
		same desired behaviors.</p> `);
      SubSection($$payload2, {
        title: "Using positive reinforcement",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Positive reinforcement may include food treats, praise, petting, or a favorite toy or game.
			...
			pocket full of goodies, but it’s fun to surprise your cat from time to time.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "The pros and cons of punishment",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Punishment can be verbal, postural or physical and is meant to make your pet immediately
...
function Scratching($$payload) {
  Section($$payload, {
    title: "Destructive scratching",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Although some people think a cat’s scratching behavior is a reflection of her distaste for a
		...
		normal reasons.</p> `);
      SubSection($$payload2, {
        title: "Why do cats scratch?",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Cats scratch for many reasons, including:</p> <ul class="list-disc pl-6"><li>To remove the dead outer layer of their claws.</li> <li>To mark their territory by leaving both a visual mark and a scent - they have scent glands
			...
			problems is to redirect the scratching onto acceptable objects.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Training your cat to scratch acceptable objects",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>You must provide objects for scratching that are appealing, attractive and convenient from
			...
			or even a month. They should then be removed gradually, not all at once.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Should I punish by cat for scratching?",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>NO! Punishment is effective only if you cat your cat in the act of scratching unacceptable
			...
			but will continue to scratch when you’re not around.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "How do I trim my cat's claws?",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>To help keep them sharp, cats keep their claws retracted until they’re needed. As the claws
			...
			all of them at once, or you’ll both have only negative memories o claw clippers!</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Should I declaw my cat?",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Declawing is a procedure whereby a veterinarian amputates the end digit and claw of a cat’s
			...
			can also lead to litter box or aggression problems.</p>`);
        }
      });
      $$payload2.out.push(`<!---->`);
    }
...
function Talk($$payload) {
  Section($$payload, {
    title: "Understanding your talkative cat",
    children: ($$payload2) => {
      $$payload2.out.push(`<p></p> <p></p> `);
      SubSection($$payload2, {
        title: "Medical reasons",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your cat’s behavior changes suddenly, the first thing you should do is take her to your
      ...
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Breed tendency",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Asian breeds, such as the Siamese, are known to be very vocal. If your cat has a pointed face
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Some cats '“talk” because they know they’ll get a reaction. People may talk back, put out some
      ...
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Your cat wants to go outside",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your cat was previously an outdoor cat and you plan to keep her safely inside, then good
			for you! The following are some suggestions to help make the transition easier on both you:</p> <ul class="list-disc pl-6"><li>Spay or Neuter Your Cat: Spaying or neutering will rid your cat of those hormonal urges to
				...
				encourage her to play or cuddle.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Grief",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>After the death or departure of a person or animal in your cat’s life, she may vocalize to
			...
			your cat does not return to her normal self, consult your veterinarian.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Transition",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your cat is new to your home or has just gone through a change - such as a person or other
...
function Toys($$payload) {
  Section($$payload, {
    title: "Cat toys and how to use them",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Although cats generally have different play styles than their canine counterparts toys are as
		...
		experience for you and your cat.</p> `);
      SubSection($$payload2, {
        title: `"Safe" toys`,
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Our mothers always told us “no playing ball in the house,” but cats can usually participate in
			...
			we can offer the following guidelines.</p>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Be cautious",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>The things that are usually most attractive to cats are often the very things that are the
      ...
      SubSection($$payload2, {
        title: "Active toys",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Round plastic shower curtain rings, which are fun either as a single ring to bat around,
				...
				a little cardboard to get them started.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Comfort toys",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Soft stuffed animals, which are good for several purposes: for some cats, the stuffed
				...
				to be especially enticing to cats.</li> <li>Cardboard boxes, especially those a little too small for your cat to fit into.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Catnip",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Catnip-filled soft toys, which cats like to kick, carry and rub: Catnip is not addictive and
				...
				aggressive play and others may become relaxed.</li> <li>Kittens under six months old seem to be immune to catnip.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!----> `);
      SubSection($$payload2, {
        title: "Getting the most out of toys",
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Rotate your cat’s toys weekly by making only a few available at a time. Keep a variety of
				...
				chasing” - and al types are much more engaging for cats when you are part of them.</li></ul>`);
        }
      });
      $$payload2.out.push(`<!---->`);
    }
...
function _page($$payload) {
  ...
  PageTitle($$payload, {
    title: "Cat Handbook",
    tag: "Your guide to cat care and adoption."
  });
  $$payload.out.push(`<!----> `);
  TocWrapper($$payload, {
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Adopting a cat is a rewarding experience, but it comes with responsibilities. This handbook
			provides essential information on cat care, behavior, and health to help you provide the best
			home for your new feline friend.</p> `);
      Introduction($$payload2);
      $$payload2.out.push(`<!----> `);
      Reinforcement($$payload2);
      $$payload2.out.push(`<!----> `);
      Behavior($$payload2);
      $$payload2.out.push(`<!----> `);
      LitterBoxIntro($$payload2);
      $$payload2.out.push(`<!----> `);
      LitterBoxProblems($$payload2);
      $$payload2.out.push(`<!----> `);
      Toys($$payload2);
      $$payload2.out.push(`<!----> `);
      Kitten($$payload2);
