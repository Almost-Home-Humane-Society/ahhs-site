...
function Behavior($$renderer) {
  Section($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Flight, flee or freeze. No, it isn’t the latest game show sweeping the nation. Instead, these
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>You’ll need to observe your cat closely to determine the trigger for their fearful behavior.
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Take the following steps to reduce your cat’s anxiety and help him or her become more
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>If your cat seriously threatens you, another person, or an animal- and the behavior is not an
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Do not punish your cat for his or her fearful behavior. Animals associate punishment with
...
function Introduction($$renderer) {
  Section($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Some cats are more social than other cats. For example, an 8-year old cat who has never been
      ...
      SubSection($$renderer2, {
        title: "Confinement",
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Confine your new cat to one medium-sized room with her litter box, water and a bed. Feed your
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Swap the sleeping blankets or beds used by all the cats so they each have a chance to become
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>It’s better to introduce your pets to each other gradually so that neither animal becomes
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Try to keep your resident pets schedules close to what they were before the newcomer’s
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>You’ll need to be even more careful when introducing a dog and a cat to one another. A dog can
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>If introductions don’t go smoothly, seek professional advice immediately from a veterinarian
...
function Kitten($$renderer) {
  Section($$renderer, {
    title: "Understanding your kittens behavior and development",
    children: ($$renderer2) => {
      $$renderer2.push(`<p>The apple doesn’t fall far from the tree, especially for cats. The fact is, well-socialized cats
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Kitten learns to orient toward sound.</li> <li>Eyes begin opening; they are usually open by 2 weeks of age.</li> <li>Competition for rank and territory begins. Separation from mother and litter mates at this
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>By the third week, sense of smell is well developed and kittens can see well though to find
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Social and object play increases kitten’s physical coordination and social skills. Most
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Kittens are most influenced by their “litter,” which may now include playmates of other
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Kitten increases exploration of dominance, including challenging humans.</li> <li>If not spayed or neutered, kitten experiences beginning of sexual behavior. (Spaying or
...
function LitterBoxIntro($$renderer) {
  Section($$renderer, {
    title: "Introducing your cat to the litter box",
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Most of us know cats are finicky eaters, but they can also be pretty picky when it comes to the
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Most people are inclined to place the litter box in an out-of-the-way spot to minimize odor
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Research has shown that most cats prefer fine-grained litters, presumably because they have a
...
function LitterBoxProblems($$renderer) {
  Section($$renderer, {
    title: "Solving litter box problems",
    children: ($$renderer2) => {
      $$renderer2.push(`<p>If you’re having hard time persuading your cat to head for the litter box when it’s appropriate,
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>It’s common for cats with medical problems to begin eliminating outside of their litter boxes.
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Because animals are highly motivated to continue soiling an area that smells like urine or
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>All animals develop preferences for a particular surface on which they like to eliminate.
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Your cat may have a location preference if:</p> <ul class="list-disc pl-6"><li>He or she always eliminates in quiet, protected places, such as under a desk, beneath a
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>If you catch your cat in the act of eliminating outside the litter box, do something to
...
function Reinforcement($$renderer) {
  Section($$renderer, {
    title: "Positive Reinforcement",
    children: ($$renderer2) => {
      $$renderer2.push(`<p>We all like to be praised rather than punished. The same is true for your cat, and that’s the
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Positive reinforcement may include food treats, praise, petting, or a favorite toy or game.
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Punishment can be verbal, postural or physical and is meant to make your pet immediately
...
function Scratching($$renderer) {
  Section($$renderer, {
    title: "Destructive scratching",
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Although some people think a cat’s scratching behavior is a reflection of her distaste for a
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Cats scratch for many reasons, including:</p> <ul class="list-disc pl-6"><li>To remove the dead outer layer of their claws.</li> <li>To mark their territory by leaving both a visual mark and a scent - they have scent glands
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>You must provide objects for scratching that are appealing, attractive and convenient from
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>NO! Punishment is effective only if you cat your cat in the act of scratching unacceptable
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>To help keep them sharp, cats keep their claws retracted until they’re needed. As the claws
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Declawing is a procedure whereby a veterinarian amputates the end digit and claw of a cat’s
...
function Talk($$renderer) {
  Section($$renderer, {
    title: "Understanding your talkative cat",
    children: ($$renderer2) => {
      $$renderer2.push(`<p></p> <p></p> `);
      SubSection($$renderer2, {
        title: "Medical reasons",
        children: ($$renderer3) => {
          $$renderer3.push(`<p>If your cat’s behavior changes suddenly, the first thing you should do is take her to your
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Asian breeds, such as the Siamese, are known to be very vocal. If your cat has a pointed face
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Some cats '“talk” because they know they’ll get a reaction. People may talk back, put out some
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<p>If your cat was previously an outdoor cat and you plan to keep her safely inside, then good
      ...
      SubSection($$renderer2, {
        title: "Grief",
        children: ($$renderer3) => {
          $$renderer3.push(`<p>After the death or departure of a person or animal in your cat’s life, she may vocalize to
      ...
      SubSection($$renderer2, {
        title: "Transition",
        children: ($$renderer3) => {
          $$renderer3.push(`<p>If your cat is new to your home or has just gone through a change - such as a person or other
...
function Toys($$renderer) {
  Section($$renderer, {
    title: "Cat toys and how to use them",
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Although cats generally have different play styles than their canine counterparts toys are as
      ...
      SubSection($$renderer2, {
        title: `"Safe" toys`,
        children: ($$renderer3) => {
          $$renderer3.push(`<p>Our mothers always told us “no playing ball in the house,” but cats can usually participate in
      ...
      SubSection($$renderer2, {
        title: "Be cautious",
        children: ($$renderer3) => {
          $$renderer3.push(`<p>The things that are usually most attractive to cats are often the very things that are the
      ...
      SubSection($$renderer2, {
        title: "Active toys",
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Round plastic shower curtain rings, which are fun either as a single ring to bat around,
      ...
      SubSection($$renderer2, {
        title: "Comfort toys",
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Soft stuffed animals, which are good for several purposes: for some cats, the stuffed
      ...
      SubSection($$renderer2, {
        title: "Catnip",
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Catnip-filled soft toys, which cats like to kick, carry and rub: Catnip is not addictive and
      ...
      SubSection($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<ul class="list-disc pl-6"><li>Rotate your cat’s toys weekly by making only a few available at a time. Keep a variety of
...
function _page($$renderer) {
  ...
  TocWrapper($$renderer, {
    children: ($$renderer2) => {
      $$renderer2.push(`<p>Adopting a cat is a rewarding experience, but it comes with responsibilities. This handbook
      ...
      $$renderer2.push(`<!----> `);
      Reinforcement($$renderer2);
      $$renderer2.push(`<!----> `);
      Behavior($$renderer2);
      $$renderer2.push(`<!----> `);
      LitterBoxIntro($$renderer2);
      $$renderer2.push(`<!----> `);
      LitterBoxProblems($$renderer2);
      $$renderer2.push(`<!----> `);
      Toys($$renderer2);
      $$renderer2.push(`<!----> `);
      Kitten($$renderer2);
