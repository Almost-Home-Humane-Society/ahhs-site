...
function BringingHome($$payload) {
  Section($$payload, {
    title: "Bringing your new dog home",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>First off, we are excited that you have decided to bring home a new dog! We want this to be a
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>We know that you have just committed to a new family member, and this can be stressful and
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>This will ensure there are no surprises and help your new dog adjust more quickly. Try to work
      ...
      SubSection($$payload2, {
        title: "Training",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>It is important that training begins early, no matter how old your new companion is.
...
function CatIntroduction($$payload) {
  Section($$payload, {
    title: "Cat to dog introductions",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>You’ll need to be even more careful when introducing a dog and cat the one another. A dog can
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your dog doesn’t already know the commands “sit,” “down,” “come,” and “stay,” begin working
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Allow your new dog and your resident cat to get to know each other’s scent. Have them eat on
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Next, allow your cat some freedom to explore your dog at her own pace, with the dog still
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Although your dog must be taught that chasing or being rough with your cat is unacceptable
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>You may want to keep your dog at your side and on-leash whenever your cat is free in the house
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Because they are so much smaller, kittens are in more danger of being injured or killed by a
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If introductions don’t go smoothly, seek professional advice immediately from a certified
  ...
  Section($$payload, {
    ...
    children: ($$payload2) => {
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>When you bring a baby home, your dog will face an overwhelming number of novel sights, sounds
      ...
      SubSection($$payload2, {
        title: "Basic manners",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Having good verbal control of your dog can really help when it comes to juggling her needs and
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>As your child develops, teach him to respect your dog’s body, safe zones and belongings.
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your dog is a little nervous about your toddler - Some dogs are nervous about toddlers or
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Dogs who are elderly, dogs who have chronic pain, and dogs with sensory deficits (such as
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Dogs who show aggression toward a toddler in the home often do so because they have no been
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Obviously, it’s important that your dog learn to inhibit her aggressive behavior towards your
...
function ClickerTraining($$payload) {
  Section($$payload, {
    title: "Clicker training",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Clicker training is a method of animal training that uses a sound (a click) to tell an animal
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>The clicker creates an efficient language between a human trainer and an animal trainee.
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>It’s easy to introduce the clicker to your pet. Spend thirty minutes or so teaching her that
      ...
      SubSection($$payload2, {
        title: "Troubleshooting",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your pet runs away when he hears the click, you can make the sound softer by putting it in
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Once your dog seems to understand the connection between the click and the treat, you’re ready
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Catching means that you catch your pet in the act of doing the behavior you want. It’s the
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>With shaping, you gradually build a new behavior by clicking and rewarding a series of small
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Luring involves using a treat like a magnet or guide to get your pet into a desired position.
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Whether you’ve used catching, shaping or luring to get a behavior you want, your next step is
      ...
      SubSection($$payload2, {
        title: "Final tips",
        children: ($$payload3) => {
          $$payload3.out.push(`<ol class="list-decimal pl-6"><li>After you add the cue, don’t reward the behavior anymore unless you first give the cue.</li> <li>Practice a new behavior in many different places so that your pet learns how to do it
...
function CrateTraining($$payload) {
  Section($$payload, {
    ...
    children: ($$payload2) => {
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>There are basically two types of crates available: a wire cage with a pull out tray or a
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>A crate must be large enough for the dog to lie down with her legs extended, stand up
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>The crate should be placed in the kitchen, living room, or well-traveled area in a quiet
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>A blanket or rug can be placed in the bottom. Be careful that your dog does not chew and/or
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Use treats to coax your dog inside. <span class="italic">Never force them in!</span> Never punish
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Your dog should be put in the crate at different times throughout the day when you are home.
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Be patient! As your dog gets used to the crate, she will feel more secure. Teach a cue word
...
function Introduction($$payload) {
  Section($$payload, {
    ...
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Animals that live in groups (like dogs) establish relationship through which the individuals
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If you have more than one resident dog in your household, it may be best to introduce the
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Introduce the dogs in a natural location so that your resident dog is less likely to view the
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>One body posture that indicates things are going well is the “play bow.” One dog will crouch
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>When the dogs seem to be tolerating each other without fearful or aggressive responses and the
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Puppies usually pester adult dogs unmercifully. Before approximately the age of four months
      ...
      SubSection($$payload2, {
        title: "When to get help",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If the introduction of a new dog to a household doesn’t go smoothly, contact a profressional
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li>Pick up all toys, chews, food bows, etc. These types of items can cause a rivalry. Once the
...
function PottyTraining($$payload) {
  Section($$payload, {
    title: "Potty training",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Nobody wants to deal with a dog that won’t stop going to the bathroom all over the floor! If
		your new dog is not acting very well potty training, these 4 keys to successful potty training
		may help:</p> `);
      SubSection($$payload2, {
        title: "Confinement",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Puppies or new dogs need to be confined in order to facilitate the easiest potty training. The
      ...
      SubSection($$payload2, {
        title: "Training",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>When teaching a new dog or puppy where to defecate, always use a leash. Leashes keep your dog
      ...
      SubSection($$payload2, {
        title: "Timing",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Puppies earn freedom by defecating appropriately. The best time for a puppy to be out of her
      ...
      SubSection($$payload2, {
        title: "Praise",
        children: ($$payload3) => {
          $$payload3.out.push(`<p>Once your puppy or new dog begins to properly defecate or pick up the habits you are teaching,
...
function Puppies($$payload) {
  Section($$payload, {
    title: "Mouthy puppies and inappropriate play",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Puppies will be puppies and they explore with their mouths, but you want to be sure to curb
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<p>If your puppy begins biting at your hands, wait until the bite is especially hard (hard enough
...
function SeparationAnxiety($$payload) {
  Section($$payload, {
    title: "Separation Anxiety",
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Many dogs are upset by even the slightest change in routine and, as a result, may become
      ...
      SubSection($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out.push(`<ul class="list-disc pl-6"><li><strong class="font-bold pr-1">Doctor Knows Best:</strong>Always take your pet for a trip to
...
function _page($$payload) {
  ...
  TocWrapper($$payload, {
    children: ($$payload2) => {
      $$payload2.out.push(`<p>Adopting a dog is a fulfilling journey, but it requires commitment and understanding. This
      ...
      BringingHome($$payload2);
      $$payload2.out.push(`<!----> `);
      Introduction($$payload2);
      $$payload2.out.push(`<!----> `);
      CatIntroduction($$payload2);
      $$payload2.out.push(`<!----> `);
      PottyTraining($$payload2);
      $$payload2.out.push(`<!----> `);
      CrateTraining($$payload2);
      $$payload2.out.push(`<!----> `);
      ClickerTraining($$payload2);
      $$payload2.out.push(`<!----> `);
      Puppies($$payload2);
      $$payload2.out.push(`<!----> `);
      SeparationAnxiety($$payload2);
      $$payload2.out.push(`<!----> `);
      Children($$payload2);
      $$payload2.out.push(`<!---->`);
    }
