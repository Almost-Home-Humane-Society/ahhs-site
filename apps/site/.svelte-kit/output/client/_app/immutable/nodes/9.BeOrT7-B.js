import"../chunks/Bzak7iHL.js";import"../chunks/69_IOA4Y.js";import{s as r,f as k,n as w,c as _,r as T}from"../chunks/CwJCq5ve.js";import{f as a,a as t}from"../chunks/Bbz8S42w.js";import{P}from"../chunks/CAVFGobz.js";import{S as $,a as i,T as I}from"../chunks/CZinCNr6.js";var x=a(`<p>We know that you have just committed to a new family member, and this can be stressful and
			...
			dog.</p>`),A=a(`<p>This will ensure there are no surprises and help your new dog adjust more quickly. Try to work
			...
			be overwhelming for her to be in a busy store with so many people and smells.</p>`,1),W=a(`<p>It is important that training begins early, no matter how old your new companion is.
			...
			confident, and can even be a fantastic stress reliever for your dog.</p>`),j=a(`<p>First off, we are excited that you have decided to bring home a new dog! We want this to be a
		positive experience so that you and your new dog can live happily together for a long time. Here
		are some tips for starting your new relationship off on the right paw:</p> <!> <!> <!>`,1);function C(m){$(m,{title:"Bringing your new dog home",children:(g,v)=>{var h=j(),u=r(k(h),2);i(u,{title:"First day home",children:(s,l)=>{var d=x();t(s,d)}});var c=r(u,2);i(c,{title:"Establish a routine",children:(s,l)=>{var d=A();w(2),t(s,d)}});var p=r(c,2);i(p,{title:"Training",children:(s,l)=>{var d=W();t(s,d)}}),t(g,h)}})}var S=a(`<p>If your dog doesn’t already know the commands “sit,” “down,” “come,” and “stay,” begin working
			...
			dog already knows these commands, works to reinforce these commands.</p>`),q=a(`<p>Allow your new dog and your resident cat to get to know each other’s scent. Have them eat on
			...
			aggression, or other undesirable behavior.</p>`),D=a(`<p>Next, allow your cat some freedom to explore your dog at her own pace, with the dog still
			...
			becomes aggressive, you’re progressing too fast. Go back to the previous introduction steps.</p>`),F=a(`<p>Although your dog must be taught that chasing or being rough with your cat is unacceptable
			...
			redirect aggression toward the cat.</p>`),H=a(`<p>You may want to keep your dog at your side and on-leash whenever your cat is free in the house
			...
			home.</p>`),B=a(`<p>Because they are so much smaller, kittens are in more danger of being injured or killed by a
			...
			matures enough to have more self- control.</p>`),z=a(`<p>If introductions don’t go smoothly, seek professional advice immediately from a certified
			...
			professional guidance.</p>`),O=a(`<p>You’ll need to be even more careful when introducing a dog and cat the one another. A dog can
		...
		transition into the home, practice these steps:</p> <!> <!> <!> <!> <!> <!> <!>`,1);function Y(m){$(m,{title:"Cat to dog introductions",children:(g,v)=>{var h=O(),u=r(k(h),2);i(u,{title:"Practice obedience",children:(o,n)=>{var e=S();t(o,e)}});var c=r(u,2);i(c,{title:"Set up controlled meetings",children:(o,n)=>{var e=q();t(o,e)}});var p=r(c,2);i(p,{title:"Let your cat go",children:(o,n)=>{var e=D();t(o,e)}});var s=r(p,2);i(s,{title:"Use positive reinforcement",children:(o,n)=>{var e=F();t(o,e)}});var l=r(s,2);i(l,{title:"Directly supervise all interactions",children:(o,n)=>{var e=H();t(o,e)}});var d=r(l,2);i(d,{title:"Kittens and puppies",children:(o,n)=>{var e=B();t(o,e)}});var y=r(d,2);i(y,{title:"When to get help",children:(o,n)=>{var e=z();t(o,e)}}),t(g,h)}})}var M=a(`<p>When you bring a baby home, your dog will face an overwhelming number of novel sights, sounds
			...
			you’ll focus on two things:</p> <ul class="list-disc pl-6"><li>Teaching your dog the skills she’ll need to interact safely with her new family member</li> <li>Helping your dog adjust to the many new experiences and changes ahead.</li></ul>`,1),L=a(`<p>Having good verbal control of your dog can really help when it comes to juggling her needs and
			the baby’s care. The following are particularly important:</p> <ul class="list-disc pl-6"><li>Sit and down</li> <li>Sit, wait at doors, and settle. These skills can help your dog learn to control her impulses
				...
				how to teach your dog this invaluable skill: <ul class="list-disc pl-6"><li>Show her a treat, say “go away,” and toss the treat four or five feet away from you.
						...
						say “yes!” and toss a treat.</li></ul></li></ul>`,1),E=a(`<p>As your child develops, teach him to respect your dog’s body, safe zones and belongings.
			...
			your child and earn a reward more quickly.</p>`,1),G=a(`<p>If your dog is a little nervous about your toddler - Some dogs are nervous about toddlers or
			...
			her own. When she seems nervous, speak softly to her and praise her for bravely investigating.</p>`,1),K=a(`<p>Dogs who are elderly, dogs who have chronic pain, and dogs with sensory deficits (such as
			...
			vigilantly separate your dog and your child than to put the two of them in a risky situation.</p>`,1),N=a(`<p>Dogs who show aggression toward a toddler in the home often do so because they have no been
			...
			she has extensive experience successfully treating aggression in dogs.</p>`,1),R=a(`<p>Obviously, it’s important that your dog learn to inhibit her aggressive behavior towards your
			...
			modification plan.</p>`,1),U=a("<!> <!> <!> <!> <!> <!> <!>",1);function V(m){$(m,{title:"Dogs and children",children:(g,v)=>{var h=U(),u=k(h);i(u,{title:"Preparing your dog for a new baby",children:(o,n)=>{var e=M();w(4),t(o,e)}});var c=r(u,2);i(c,{title:"Basic manners",children:(o,n)=>{var e=L();w(6),t(o,e)}});var p=r(c,2);i(p,{title:"Teach your child to respect your dog",children:(o,n)=>{var e=E();w(6),t(o,e)}});var s=r(p,2);i(s,{title:"Troubleshooting",children:(o,n)=>{var e=G();w(2),t(o,e)}});var l=r(s,2);i(l,{title:"Older or disabled dogs",children:(o,n)=>{var e=K();w(8),t(o,e)}});var d=r(l,2);i(d,{title:"Aggressive behavior",children:(o,n)=>{var e=N();w(2),t(o,e)}});var y=r(d,2);i(y,{title:"Correcting aggressive behavior",children:(o,n)=>{var e=R();w(2),t(o,e)}}),t(g,h)}})}var J=a(`<p>The clicker creates an efficient language between a human trainer and an animal trainee.
			...
			the trianer communicates precisely with the dog, and that speeds up the training.</p>`,1),Q=a(`<p>It’s easy to introduce the clicker to your pet. Spend thirty minutes or so teaching her that
			...
			to clicker train a dog.</p> <ol class="list-decimal pl-6"><li>Sit and watch TV or read a book with your dog in the room. Have a container within reach.</li> <li>Place one treat in your hand and the clicker int he other. If your dog smells the treat and
				...
				clicker means at treat is coming her way.</li></ol>`,1),X=a(`<p>If your pet runs away when he hears the click, you can make the sound softer by putting it in
			your pocket or wrapping a towel around your hand that’s holding the clicker. You can also try
			using a different sound, like the click of a retractable pen or the words “yes” or “bingo.”</p>`),Z=a(`<p>Once your dog seems to understand the connection between the click and the treat, you’re ready
			to get started. Keep these guidelines in mind to ensure your clicker training success:</p> <ul class="list-disc pl-6"><li>Click just once, right when your pet does what you want him to do. Think of it like pressing
				...
				has accomplished a particularly challenging task. Big efforts deserve big rewards!</li></ul>`,1),ee=a(`<p>Catching means that you catch your pet in the act of doing the behavior you want. It’s the
			...
			not he ground to earn her treat.</p>`),oe=a(`<p>With shaping, you gradually build a new behavior by clicking and rewarding a series of small
			...
			learning is fun and will soon be performing the goal behavior with enthusiasm.</p>`),te=a(`<p>Luring involves using a treat like a magnet or guide to get your pet into a desired position.
			...
			certain behaviors.</p>`),ae=a(`<p>Whether you’ve used catching, shaping or luring to get a behavior you want, your next step is
			...
			will eventually lean what the cue means.</p>`,1),re=a(`<ol class="list-decimal pl-6"><li>After you add the cue, don’t reward the behavior anymore unless you first give the cue.</li> <li>Practice a new behavior in many different places so that your pet learns how to do it
				...
				private lessons.</li></ol>`),ie=a(`<p>Clicker training is a method of animal training that uses a sound (a click) to tell an animal
		...
		and domestic - from lions to elephants to household rats, cats and birds!</p> <!> <!> <!> <!> <!> <!> <!> <!> <!>`,1);function ne(m){$(m,{title:"Clicker training",children:(g,v)=>{var h=ie(),u=r(k(h),2);i(u,{title:"How does it work?",children:(e,b)=>{var f=J();w(2),t(e,f)}});var c=r(u,2);i(c,{title:"Giving the clicker meaning",children:(e,b)=>{var f=Q();w(2),t(e,f)}});var p=r(c,2);i(p,{title:"Troubleshooting",children:(e,b)=>{var f=X();t(e,f)}});var s=r(p,2);i(s,{title:"Clicker training basics",children:(e,b)=>{var f=Z();w(2),t(e,f)}});var l=r(s,2);i(l,{title:"Catching behavior",children:(e,b)=>{var f=ee();t(e,f)}});var d=r(l,2);i(d,{title:"Shaping behavior",children:(e,b)=>{var f=oe();t(e,f)}});var y=r(d,2);i(y,{title:"Luring behavior",children:(e,b)=>{var f=te();t(e,f)}});var o=r(y,2);i(o,{title:"Adding the cue",children:(e,b)=>{var f=ae();w(4),t(e,f)}});var n=r(o,2);i(n,{title:"Final tips",children:(e,b)=>{var f=re();t(e,f)}}),t(g,h)}})}var se=a(`<p>There are basically two types of crates available: a wire cage with a pull out tray or a
			...
			helping with housebreaking and destructive chewing.</p>`),he=a(`<p>A crate must be large enough for the dog to lie down with her legs extended, stand up
			...
			sleep in the other.</p>`),le=a(`<p>The crate should be placed in the kitchen, living room, or well-traveled area in a quiet
			...
			puppy can be taken out as needed.</p>`),de=a(`<p>A blanket or rug can be placed in the bottom. Be careful that your dog does not chew and/or
			swallow the bedding material. Always provide toys such as a Kong stuffed with peanut butter
			and treats, Nylabones, or other chew toys.</p>`),ue=a(`<p>Use treats to coax your dog inside. <span class="italic">Never force them in!</span> Never punish
			...
			was correct and will reinforce the proper behavior.</p>`,1),ce=a(`<p>Your dog should be put in the crate at different times throughout the day when you are home.
			...
			for, your love and attention.</p>`,1),pe=a(`<p>Be patient! As your dog gets used to the crate, she will feel more secure. Teach a cue word
			such as “kennel up” or “crate.” Before long, your dog will know exactly what to do when she
			hears the cue word. Don’t forget to praise her when she goes in the crate on command!</p>`),ge=a("<!> <!> <!> <!> <!> <!> <!>",1);function ye(m){$(m,{title:"Crate training",children:(g,v)=>{var h=ge(),u=k(h);i(u,{title:"What is a crate?",children:(o,n)=>{var e=se();t(o,e)}});var c=r(u,2);i(c,{title:"How big should the crate be?",children:(o,n)=>{var e=he();t(o,e)}});var p=r(c,2);i(p,{title:"Where should the crate be kept?",children:(o,n)=>{var e=le();t(o,e)}});var s=r(p,2);i(s,{title:"What do I put inside the crate?",children:(o,n)=>{var e=de();t(o,e)}});var l=r(s,2);i(l,{title:"How can I get my dog inside the crate?",children:(o,n)=>{var e=ue();w(4),t(o,e)}});var d=r(l,2);i(d,{title:"When should by dog be in the crate?",children:(o,n)=>{var e=ce();w(2),t(o,e)}});var y=r(d,2);i(y,{title:"What if my dog doesn't like to be in the crate?",children:(o,n)=>{var e=pe();t(o,e)}}),t(g,h)}})}var me=a(`<p>If you have more than one resident dog in your household, it may be best to introduce the
			resident dogs to the new dog one at a time. Two or more resident dogs may have a tendency to
			“gang up” on the newcomer.</p>`),fe=a(`<p>Introduce the dogs in a natural location so that your resident dog is less likely to view the
			...
			congratulating them on walking near each other without any issues.</p>`),we=a(`<p>One body posture that indicates things are going well is the “play bow.” One dog will crouch
			...
			dog’s body language that can be misinterpreted by the other dog.</p> <p>See the section “Walking with Your Dog” for more information on loose leash walking.</p>`,1),ve=a(`<p>When the dogs seem to be tolerating each other without fearful or aggressive responses and the
			...
			and when two dogs are playing to avoid accidents.</p>`,1),be=a(`<p>Puppies usually pester adult dogs unmercifully. Before approximately the age of four months
			...
			from the puppy, the adult dog will likely be happier when it is time to see the puppy.</p>`),ke=a(`<p>If the introduction of a new dog to a household doesn’t go smoothly, contact a profressional
			...
			can often be resolved with professional help.</p>`),$e=a(`<ul class="list-disc pl-6"><li>Pick up all toys, chews, food bows, etc. These types of items can cause a rivalry. Once the
				...
				towards the ball. The excitement of fetch can cause conflict in ball-focused dogs.</li> <li>Feed the dogs in completely separate areas and pick up bowls when they are done.</li> <li>Confine the dogs in separate areas whenever you’re away.</li></ul>`),_e=a(`<p>Animals that live in groups (like dogs) establish relationship through which the individuals
		...
		relationship.</p> <!> <!> <!> <!> <!> <!> <!>`,1);function Te(m){$(m,{title:"Introducing your new dog to your home",children:(g,v)=>{var h=_e(),u=r(k(h),2);i(u,{title:"Introduce one dog at a time",children:(o,n)=>{var e=me();t(o,e)}});var c=r(u,2);i(c,{title:"Choose a neutral location",children:(o,n)=>{var e=fe();t(o,e)}});var p=r(c,2);i(p,{title:"Be aware of body postures",children:(o,n)=>{var e=we();w(2),t(o,e)}});var s=r(p,2);i(s,{title:"Taking the dogs home",children:(o,n)=>{var e=ve();w(8),t(o,e)}});var l=r(s,2);i(l,{title:"Introducing puppies to adult dogs",children:(o,n)=>{var e=be();t(o,e)}});var d=r(l,2);i(d,{title:"When to get help",children:(o,n)=>{var e=ke();t(o,e)}});var y=r(d,2);i(y,{title:"Additional tips for successful introduction",children:(o,n)=>{var e=$e();t(o,e)}}),t(g,h)}})}var Pe=a(`<p>Puppies or new dogs need to be confined in order to facilitate the easiest potty training. The
			...
			homemade insert or a crate insert made by the crate company to fit your crate.</p>`),Ie=a(`<p>When teaching a new dog or puppy where to defecate, always use a leash. Leashes keep your dog
			...
			Remember when you choose your word or phrase that you will be repeating it a lot.</p>`),xe=a(`<p>Puppies earn freedom by defecating appropriately. The best time for a puppy to be out of her
			...
			more likely to continue performing this action.</p>`),We=a(`<p>Nobody wants to deal with a dog that won’t stop going to the bathroom all over the floor! If
		your new dog is not acting very well potty training, these 4 keys to successful potty training
		may help:</p> <!> <!> <!> <!>`,1);function je(m){$(m,{title:"Potty training",children:(g,v)=>{var h=We(),u=r(k(h),2);i(u,{title:"Confinement",children:(l,d)=>{var y=Pe();t(l,y)}});var c=r(u,2);i(c,{title:"Training",children:(l,d)=>{var y=Ie();t(l,y)}});var p=r(c,2);i(p,{title:"Timing",children:(l,d)=>{var y=xe();w(2),t(l,y)}});var s=r(p,2);i(s,{title:"Praise",children:(l,d)=>{var y=Ae();t(l,y)}}),t(g,h)}})}var Ce=a(`<p>If your puppy begins biting at your hands, wait until the bite is especially hard (hard enough
			...
			consult a licensed dog behaviorist or pet trainer.</p>`,1),Se=a(`<p>Puppies will be puppies and they explore with their mouths, but you want to be sure to curb
		...
		some time and consistency.</p> <!>`,1);function qe(m){$(m,{title:"Mouthy puppies and inappropriate play",children:(g,v)=>{var h=Se(),u=r(k(h),2);i(u,{title:"Puppy chewing on hands",children:(c,p)=>{var s=Ce();w(6),t(c,s)}}),t(g,h)}})}var De=a(`<ul class="list-disc pl-6"><li><strong class="font-bold pr-1">Doctor Knows Best:</strong>Always take your pet for a trip to
				...
				by the pet parent.</li></ul>`),Fe=a(`<p>Many dogs are upset by even the slightest change in routine and, as a result, may become
		anxious. These behaviors are usually worse when left alone and could include barking, howling,
		chewing, urinating in the house, pacing, or even trying to escape.</p> <!>`,1);function He(m){$(m,{title:"Separation Anxiety",children:(g,v)=>{var h=Fe(),u=r(k(h),2);i(u,{title:"What can I do to help?",children:(c,p)=>{var s=De();t(c,s)}}),t(g,h)}})}var Be=a(`<p>Adopting a dog is a fulfilling journey, but it requires commitment and understanding. This
			handbook offers crucial insights into dog care, behavior, and health to ensure you provide the
			best environment for your new canine companion.</p> <!> <!> <!> <!> <!> <!> <!> <!> <!>`,1),ze=a('<div class="flex flex-col basis-full gap-6"><!> <!></div>');function Ke(m){var g=ze(),v=_(g);P(v,{title:"Dog Handbook",tag:"Your guide to dog care and adoption."});var h=r(v,2);I(h,{children:(u,c)=>{var p=Be(),s=r(k(p),2);C(s);var l=r(s,2);Te(l);var d=r(l,2);Y(d);var y=r(d,2);je(y);var o=r(y,2);ye(o);var n=r(o,2);ne(n);var e=r(n,2);qe(e);var b=r(e,2);He(b);var f=r(b,2);V(f),t(u,p)},$$slots:{default:!0}}),T(g),t(m,g)}export{Ke as component};
