...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/about" | "/blog" | "/blog/components" | "/blog/[slug]" | "/cats" | "/cats/available" | "/dogs" | "/dogs/available" | "/donate" | "/events" | "/events/components" | "/events/[slug]" | "/faq" | "/handbooks" | "/handbooks/cat" | "/handbooks/cat/sections" | "/handbooks/dog" | "/handbooks/dog/sections" | "/pocket-pals" | "/pocket-pals/available" | "/resources" | "/resources/local" | "/resources/lost-and-found" | "/resources/microchipping" | "/resources/pet-food-assistance" | "/resources/vaccinations";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/blog": { slug?: string };
			"/blog/components": Record<string, never>;
			"/blog/[slug]": { slug: string };
