...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/about" | "/blog" | "/blog/[id]" | "/cats" | "/cats/available" | "/dogs" | "/dogs/available" | "/donate" | "/events" | "/events/components" | "/faq" | "/handbooks" | "/handbooks/cat" | "/handbooks/cat/sections" | "/handbooks/dog" | "/handbooks/dog/sections" | "/pocket-pals" | "/pocket-pals/available" | "/resources" | "/resources/local" | "/resources/lost-and-found" | "/resources/microchipping" | "/resources/pet-food-assistance" | "/resources/vaccinations";
		RouteParams(): {
			"/blog/[id]": { id: string }
		};
		LayoutParams(): {
