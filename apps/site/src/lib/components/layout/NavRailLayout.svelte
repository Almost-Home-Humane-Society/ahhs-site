<script lang="ts">
	...
	let pinned = $derived.by<boolean>(() => false);
		...
		>
			<div class="flex flex-row items-center w-full gap-3">
				...
				<div class="flex flex-row items-center">
					<div class="hidden lg:flex flex-row items-center gap-2 lg:gap-6">
						<a
							class="cursor-pointer flex flex-row gap-1 items-center"
							href="https://adoptafriend.itemorder.com/shop/home/"
							target="_blank"
						>
							<span class="icon-[material-symbols--shopping-bag] size-5"></span>
							Shop
						</a>
						<a class="cursor-pointer flex flex-row gap-1 items-center" href="/donate">
							<span class="icon-[lucide--heart-handshake] size-5"></span>
							Donate
						</a>
					</div>
