...
<div class="flex flex-col basis-full gap-6">
	<PageTitle title="About Us" tag="How we serve our community" />
	<PageWrapper>
		<p>
		...
		<section class="flex flex-col basis-full gap-3">
			<h3 class="text-2xl font-medium">Lifesaving Data</h3>
			<p>
				In {priorYear}, Almost Home saved 94.9% of the pets that needed its help. This is calculated
				...
				status of every animal in our care.
			</p>
			<p>
				Almost Home’s lifesaving rate (95%) is consistently several times above the national average
				...
				adoption, transfer, or return to owner. <span class="italic"
					>Reasons an animal might leave the shelter other than adoption include being transferred
					to another (sometimes breed-specific) rescue or a lost pet being returned to its owner.</span
				>
			</p>
			<p>
				AHHS is especially proud of this number because it has no control over the health or
			...
			<p>
				Almost Home never euthanizes a pet due to space or time considerations. However, AHHS must
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div class="flex flex-col gap-3 justify-center">
					<p class="text-sm">
						*Stray pets are brought to Almost Home and held for 5 full days awaiting reunion with
						their owner
					</p>
					<p class="text-sm">
						*Pets transferred in arrive at Almost Home from other shelters or rescues.
					</p>
					<p class="text-sm">*Returns are animals brought back to Almost Home after adoption</p>
					<p class="text-sm">
					...
					<p class="text-sm">
						*SNAP = Spay/Neuter Assistance Program and is available to residents of Tippecanoe
						County on government assistance
					</p>
				</div>
			</div>
		</section>
		<section class="flex flex-col basis-full gap-3">
			<h3 class="text-2xl font-medium">Frequently Asked Questions</h3>
			<p>
				<a class="link" href="/faq">Click here</a> to view all our frequently asked questions.
			</p>
		</section>
	</PageWrapper>
</div>
